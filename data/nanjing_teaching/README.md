...
本目录中的生成式教学数据采用[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)许可。学生可以下载、复制、修改和分享这些文件，也可以把经过修改的数据用于作业、课堂展示和研究方法复现。公开分享时应保留数据性质说明并进行署名：

> 蔡子攀（2026），《数据科学与城市空间研究》南京教学样例数据，CC BY 4.0，https://github.com/zipan07/urban-spatial-data-science 。

该许可不改变数据的教学性质：任何使用者均不得将其中的数值、位置与设施记录表述为南京市官方统计、真实设施名录或规划结论。
